...
const sentenceVariants = {
  ...
  visible: {
    ...
    transition: {
      ...
      staggerChildren: 2.15, // Time between each child animation (appearance)
...
const wordVariants = {
  hidden: { opacity: 0, x: -20, transition: { duration: 1, ease: 'easeOut' } },
    ...
    const sequence = async () => {
      ...
      while (true) {
        ...
        const visibleDuration =
          (sentenceVariants.visible.transition.delay || 0) * 1000 +
        ...
        const exitDuration =
          words.length * (sentenceVariants.exit.transition.staggerChildren || 0) * 1000 +
